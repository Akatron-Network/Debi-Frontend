    ...
    <div htmlFor="chart_choose" className="modal bg-modal_back">
      <div className="modal-box relative max-w-fit p-3 bg-side_black rounded grid grid-cols-7 gap-3 h-[80%]">
        ...
        <div className='col-span-6'>
          <label htmlFor="chart_choose" className="btn gray-btn absolute right-2 top-2 z-10" onClick={chart_data.clearPanelInputs}><i className="fa-solid fa-xmark"></i></label>
